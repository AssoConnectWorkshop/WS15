      ...
      {genState === 'done' && (
        <div className="space-y-4">
          ...
          <div className="flex justify-between pt-2">
            ...
            <button onClick={() => router.push(`/rapport/${id}/editeur`)} className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-bold px-6 py-3 rounded-xl shadow-lg shadow-indigo-200 hover:scale-105 transition-all">
              Peaufiner le rapport ✏️ →
            </button>
          </div>
        </div>
      )}
